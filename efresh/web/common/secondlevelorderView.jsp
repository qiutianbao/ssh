...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/secondlevelorderstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/secondlevelorderView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="secondlevelorderGrid" style="width:100%;height:100%"></div>
