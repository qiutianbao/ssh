...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/integraltotalstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/integraltotalView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="integraltotalGrid" style="width:100%;height:100%"></div>
