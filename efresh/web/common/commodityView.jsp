...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/commoditystoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/commodityView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="commodityGrid" style="width:100%;height:100%"></div>
