...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/substationstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/substationView.js"></script>
<script type="text/javascript" language="javascript">
  ...
  <body onkeydown="keyConvert()">
    ...
    <div id="substationGrid" style="width:100%;height:100%"></div>
