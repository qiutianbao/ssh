...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/store_stylestoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/store_styleView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="store_styleGrid" style="width:100%;height:100%"></div>
