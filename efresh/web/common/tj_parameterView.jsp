...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/tj_parameterstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/tj_parameterView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="tj_parameterGrid" style="width:100%;height:100%"></div>
