...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/store_productstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/store_productView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="store_productGrid" style="width:100%;height:100%"></div>
