...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/fristlevelorderstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/fristlevelorderView.js"></script>
