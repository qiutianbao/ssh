...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/tradingrecordsstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/tradingrecordsView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="tradingrecordsGrid" style="width:100%;height:100%"></div>
