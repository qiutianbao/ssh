...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/sysmsgimagesstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/sysmsgimagesView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="sysmsgimagesGrid" style="width:100%;height:100%"></div>
