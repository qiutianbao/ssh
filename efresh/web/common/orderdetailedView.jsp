...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/orderdetailedstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/orderdetailedView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="orderdetailedGrid" style="width:100%;height:100%"></div>
