...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/commoditypricestoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/commoditypriceView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="commoditypriceGrid" style="width:100%;height:100%"></div>
