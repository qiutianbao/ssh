...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/storebrandstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/storebrandView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="storebrandGrid" style="width:100%;height:100%"></div>
