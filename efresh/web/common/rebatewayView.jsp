...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/rebatewaystoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/rebatewayView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="rebatewayGrid" style="width:100%;height:100%"></div>
