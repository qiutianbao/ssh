...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/accountrevenuestoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/accountrevenueView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="accountrevenueGrid" style="width:100%;height:100%"></div>
