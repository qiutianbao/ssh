...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/outlibrarystoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/outlibraryView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="outlibraryGrid" style="width:100%;height:100%"></div>
