...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_inst_mgmtstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_inst_mgmtView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_inst_mgmtGrid" style="width:100%;height:100%"></div>
