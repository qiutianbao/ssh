...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_excel_infostoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_excel_infoView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_excel_infoGrid" style="width:100%;height:100%"></div>
