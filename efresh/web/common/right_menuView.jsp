...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/right_menustoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/right_menuView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="right_menuGrid" style="width:100%;height:100%"></div>
