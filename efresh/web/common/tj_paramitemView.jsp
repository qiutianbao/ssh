...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/tj_paramitemstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/tj_paramitemView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="tj_paramitemGrid" style="width:100%;height:100%"></div>
