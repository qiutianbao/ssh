...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/sysmsgcontentstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/sysmsgcontentView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="sysmsgcontentGrid" style="width:100%;height:100%"></div>
