...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_available_nostoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_available_noView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_available_noGrid" style="width:100%;height:100%"></div>
