...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/integralrulestoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/integralruleView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="integralruleGrid" style="width:100%;height:100%"></div>
