...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/useraccountstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/useraccountView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="useraccountGrid" style="width:100%;height:100%"></div>
