...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/rechargerulesstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/rechargerulesView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="rechargerulesGrid" style="width:100%;height:100%"></div>
