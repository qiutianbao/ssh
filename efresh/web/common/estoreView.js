 ...
 Ext.onReady( function(){
	...
	haveRight('common/estoreView.jsp');
	 queryestoreStore = new Ext.data.JsonStore({
		url : 'estore_findAll.action?selftsales=N',
		root : 'estoreList',
...
//	var tempString = '<a href="https://www.baidu.com/" class="mayubtn">查看更多</a>';
	var tempString = '<div class="mabgt"><a href="estore_detail.action?estore.idNumber='+value+'" class="mayubtn">查看更多</a><a href="#" class="stop_yun">停运</a><div class="clear"></div></div>';
	return tempString;
	}
}
],
		...
		tbar : [{
			...
			handler : function() {
				//addestore();
				window.location.href = "jsp/esys/setshop2.jsp";
			}
		}
//		,'-',{text:"导出Excel", 
