...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/categorystoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/categoryView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="categoryGrid" style="width:100%;height:100%"></div>
