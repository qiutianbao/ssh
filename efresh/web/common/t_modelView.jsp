...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/##tableName##storeLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/##tableName##View.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="##tableName##Grid" style="width:100%;height:100%"></div>
