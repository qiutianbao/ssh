...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_gloss_infostoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_gloss_infoCheck.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_gloss_infoGrid" style="width:100%;height:100%"></div>
