...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/sub_integralruleView.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/integralstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/integralView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="integralGrid" style="width:100%;height:100%"></div>
