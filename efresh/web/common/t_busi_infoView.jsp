...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_busi_infostoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_busi_infoView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_busi_infoGrid" style="width:100%;height:100%"></div>
