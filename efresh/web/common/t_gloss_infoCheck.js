 ...
 Ext.onReady( function(){
	...
	haveRight('common/t_gloss_infoView.jsp');
	 queryt_gloss_infoStore = new Ext.data.JsonStore({
		url : 't_gloss_info_findCheckAll.action',
...
url : 't_gloss_info_findCheckInfoByConditions.action?'
...
width : 120 
	...
	width : 120 
		...
		tbar : [{
			...
			iconCls:'icon-del',
			handler : function() {
			tlr_check (queryt_gloss_infoGrid, queryt_gloss_infoStore, "t_gloss_info_check.action", "idNumber", "复核信息");
			}
		},'-',{text:"导出Excel", 
