...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/t_tlr_mgmtstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/t_tlr_mgmtView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="t_tlr_mgmtGrid" style="width:100%;height:100%"></div>
