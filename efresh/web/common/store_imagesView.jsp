...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/store_imagesstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/store_imagesView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="store_imagesGrid" style="width:100%;height:100%"></div>
