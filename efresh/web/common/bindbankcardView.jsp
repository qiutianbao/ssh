...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/bindbankcardstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/bindbankcardView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="bindbankcardGrid" style="width:100%;height:100%"></div>
