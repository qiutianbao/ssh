...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/storagestoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/storageView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="storageGrid" style="width:100%;height:100%"></div>
