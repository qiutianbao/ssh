...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/commoditylevelstoreLoad.js"></script>
	<script type="text/javascript" src="<%=basePath%>common/commoditylevelView.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
  	
    <div id="commoditylevelGrid" style="width:100%;height:100%"></div>
