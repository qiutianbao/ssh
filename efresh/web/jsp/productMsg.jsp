...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>new_script/marketing/productMsg.js"></script>

  </head>
  
  <body onkeydown="keyConvert()">
 	<input  type="hidden" id="pro_idnumber" name="pro_idnumber" value="<%=proId%>"></input>
    <div id="proGrid" style="width: 100%; height: 100%"></div>
  </body>
</html>
