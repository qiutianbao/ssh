...
Ext.onReady(function() {
	...
	// rightDeptStore.load();
		...
		showQueryPanel = new Ext.Panel( {
			width : '100%',
			id : 'fitpanel',
			renderTo : 't_gloss_infoSurrender',
			items : [ queryt_gloss_infoGrid ]
		});
		var divHeight = document.getElementById('t_gloss_infoSurrender').offsetHeight;
		var divWidth = document.getElementById('t_gloss_infoSurrender').offsetWidth;
