...
<!-- <script type="text/javascript" src="script/esys/setshop.js"></script> -->
...
<div class="container">
  <div class="login_bg" style="height:auto">
      ...
      <div class="w1200">
        <div class="login-main">
          <div class="tycoon">
            ...
            <p class="float_r f18 font1"><!-- <span class="font0">我是企业，</span> --><a href="login.jsp" class="font1">我要登陆</a></p>
          </div>
          <div class="clear"></div>
        </div>
      </div>
    ...
    <div class="w1200k">
      ...
      <select class="area default5 selectcheck" data-value="天河区" name="estore.area" data-first-title="选择地区">
        ...
        <input type="button" class="tjbtn" value="提交"/>
      </form>
      <!---->
