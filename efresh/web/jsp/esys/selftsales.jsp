  ...
  <div class="login_bg">
    ...
    <div class="w1200k" style="width:1000px;margin-left:-500px;">
      <form name="setMassage" action="addestore_add.action" method="post" enctype="multipart/form-data"> 
        	<input type="hidden" value="Y" name="selftsales">
        	<input type="hidden" value="addselftstore" name="flag">
        <div class="manly_top">
            ...
            <table  border="0" cellpadding="0" cellspacing="0">
              <tbody>
                ...
                <tr>
                  <td align="right">手机号码：</td>
                  <td><div class="meadow">
                      <input type="text" class="meadow_txt phoneNum checkNull exists"  name="t_tlr_mgmt.phone"  maxlength="15" />
                    </div>
                    <span id="errorMsg"></span>
                    </td>
                </tr>
