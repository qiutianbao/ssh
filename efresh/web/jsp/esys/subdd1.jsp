 	...
 	<body bgcolor="transparent" style='background:transparent'>
		...
		<div class="iframe_main2">
			...
			<div class="iframe_wrap">
				...
				<strong class="cktitle">一级订单</strong>
				<div class="Atlantic">
					<div class="attain">
					...
					<div class="attain">
						...
						<input type="text" class="attract August" name="fristlevelorder.arrivalpeople" value="${fristlevelorder.arrivalpeople }" readonly />
					</div>
					<div class="attain">
						<p class="showhade attribute">联系方式：</p>
						<input type="text" class="attract" name="fristlevelorder.arrivalpeopletel" value="${fristlevelorder.arrivalpeopletel }" readonly />
					</div>
					<div class="attain">
						<p class="showhade attribute">订单状态：</p>
						<c:if test="${fristlevelorder.orderstatus == 0 }">
							<input type="text" class="attract August status" value="待处理"  readonly/>
						</c:if>
						<c:if test="${fristlevelorder.orderstatus == 1 }">
							<input type="text" class="attract August status" value="已下单"  readonly/>
						</c:if>
						<c:if test="${fristlevelorder.orderstatus == 2 }">
							<input type="text" class="attract August status" value="已接单" readonly/>
						</c:if>
						<c:if test="${fristlevelorder.orderstatus == 3 }">
							<input type="text" class="attract August status" value="已拒单" readonly/>
						</c:if>
						<c:if test="${fristlevelorder.orderstatus == 4 }">
							<input type="text" class="attract August status" value="已取消" readonly/>
						</c:if>
						<c:if test="${fristlevelorder.orderstatus == 5 }">
							<input type="text" class="attract August status" value="已签收" readonly/>
						</c:if>
					</div>
				...
				<div class="Atlantic">
					...
					<div class="attain">
						...
						<input type="text" class="attract bother" name="fristlevelorder.arrivaltime" value="${fristlevelorder.arrivaltime }" readonly />
					</div>
			...
			<c:if test="${ fristlevelorder.orderstatus == 0}">
				...
				<a href="javascript:;" class="btn btn-lg btn-warning sendOrder" >确认订单</a>
				<a href="javscript:;" class="btn btn-lg btn-warning cancelOrder" >拒绝订单</a>
				</div>
			</c:if>
			</form>
			</div>
