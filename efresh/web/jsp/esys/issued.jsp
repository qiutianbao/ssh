        ...
        <table width="728" border="0" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
              ...
              <td width="610"><div class="ktxt1 float_l">
                  <input type="text" class="ktxt1-gb" value="2016-02-20  15:30" readonly name="sysmessage.releasetime"/>
                </div>
                <div class="switch2"><a href="javascript:;" id="sethbtn"><img src="images/esys/sethubtn.png"/></a><span>切换为发布图文消息</span></div></td>
            </tr>
            <tr>
              <td align="right"><span class="msgtitle">标题：</span></td>
              <td><div class="ktxt2">
                  <input type="text" class="ktxt2-gb" value="" name="sysmessage.msgtitle" />
                </div></td>
            </tr>
            <tr class="gohubox">
              <td align="right">子标题：</td>
              <td><div class="ktxt3 float_l">
                  <input type="text" class="ktxt3-gb" value=""  name="sysmsgcontent.subTitle"/>
                </div>
                <a href="javascript:;" id="add_set"><img src="images/esys/204.png" width="28" height="28"/></a></td>
            </tr>
            <tr class="gohubox">
              <td align="right">上传图片：</td>
              <td><div class="seth_img">
                  <p class="call_img" id="gstImg1"><img src="images/esys/hsfg.png" class="gsvImg">
                  <input type="file" class="bdox" onChange="gstFor(this)" name="file"  value=""/>
                  </p>
            ...
            <tr class="ggact">
              ...
              <td><textarea cols="50" rows="8" class="ktxt2-area"  name="sysmsgcontent.msgcontent"></textarea></td>
            </tr>
          </tbody>
        </table>
       <input type="submit" class="subfbu" value="发布"/>
      </div>
    </form>
  </div>
  <div class="clear"></div>
...
$('.notice').on('click','.call_img',function(){
	...
	var _index=$(this).parents('.gohubox').index()/3;
	_conIndex=_index;
	//alert(_conIndex);
	});
