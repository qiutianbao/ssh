...
<div class="sele_main">
<form id = "form1"name="form1" method="post" action="storages_addNewInfo.action">
<s:hidden name= "idNumber"></s:hidden>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        <td width="15%" align="center">商品名称</td>
        <td width="35%">
	       <select name="storage.commodity.idNumber" id="validate-selection">
        ...
        <td width="34%"><input onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" type="text" class="st_stg" id="st_stgs" name="storage.storagenum"/><span class="warn_txt"></span></td>
      </tr>
      <tr>
        <td align="center">规格</td>
        <td><input type="text" class="gg_weight st_stg" id="weight" name="storage.specifications"/><span class="warn_txt"></span></td>
        <td align="center">单价</td>
        <td><input type="text" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false" class="only_peice st_stg" id = "price" name="storage.price"/><span class="warn_txt"></span></td>
      </tr>
      <tr>
        <td align="center">重量</td>
        <td><input type="text" id="allwight" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false" class="gy_all_weight st_stg" name="storage.weight"/><span class="warn_txt"></span></td>
        <td align="center">单位</td>
        <td><input type="text" class="gy_dw st_stg" id = "stg" name="storage.company"/><span class="warn_txt"></span></td>
      </tr>
      <tr>
