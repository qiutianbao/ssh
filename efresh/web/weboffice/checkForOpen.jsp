...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("http://localhost:8080/efresh/weboffice/upload/checkopen.doc", "wps");
...
function SaveDoc(fileName) {
	...
	//var returnValue =webObj.HttpPost("http://127.0.0.1:8080/efresh/weboffice/do_upload.czh");
}


//复核
function subCheck(fileName) {
	...
	webObj.HttpAddPostString("DocTitle", "开口话术");
	webObj.HttpAddPostCurrFile("file1", fileName); 
	var returnValue =webObj.HttpPost("<%=basePath%>/weboffice/check_upload.czh");
//	var returnValue =webObj.HttpPost("http://127.0.0.1:8080/efresh/weboffice/check_upload.czh");
}
// 事件
...
<body>
	<tr>
	<td><input type="button" value="退回文档" onclick="SaveDoc('open')" /></td>
	<td><input type="button" value="复核通过" onclick="subCheck('finalopen')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
