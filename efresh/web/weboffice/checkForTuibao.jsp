...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("http://localhost:8080/efresh/weboffice/upload/checktuibao.doc", "wps");
...
<body>
	<tr>
	<td><input type="button" value="退回文档" onclick="SaveDoc('tuibao')" /></td>
	<td><input type="button" value="复核通过" onclick="subCheck('finaltuibao')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
