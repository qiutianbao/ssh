...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("<%=basePath%>/weboffice/upload/yingxiao.doc", "wps");
...
<body>
	<tr>
	<td><input type="button" value="保存文档" onclick="SaveDoc('yingxiao')" /></td>
	<td><input type="button" value="提交复核" onclick="SaveDoc('checkyingxiao')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
