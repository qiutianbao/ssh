...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("<%=basePath%>/weboffice/upload/tuibao.doc", "wps");
...
<body>
	<tr>
	<td><input type="button" value="保存文档" onclick="SaveDoc('tuibao')" /></td>
	<td><input type="button" value="提交复核" onclick="SaveDoc('checktuibao')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
