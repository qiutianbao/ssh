...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("http://localhost:8080/efresh/weboffice/upload/checktous.doc", "wps");
...
<body>
	<tr>
	<td><input type="button" value="退回文档" onclick="SaveDoc('tous')" /></td>
	<td><input type="button" value="复核通过" onclick="subCheck('finaltous')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
