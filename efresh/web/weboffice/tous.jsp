...
<%
	...
	String tlr_name ="";
	if(null!=t_tlr_mgmt){
		 tlr_name =t_tlr_mgmt.getTlr_name();
	}
...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("<%=basePath%>/weboffice/upload/tous.doc", "doc");
...
<body>
	<tr>
	<td><input type="button" value="保存文档" onclick="SaveDoc('tous')" /></td>
	<td><input type="button" value="提交复核" onclick="SaveDoc('checktous')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
