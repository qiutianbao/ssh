...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("http://localhost:8080/efresh/weboffice/upload/checkyingxiao.doc", "wps");
...
function SaveDoc(fileName) {
	...
	webObj.HttpAddPostString("DocTitle", "投诉处理");
...
<body>
	<tr>
	<td><input type="button" value="退回文档" onclick="SaveDoc('yingxiao')" /></td>
	<td><input type="button" value="复核通过" onclick="subCheck('finalyingxiao')" /></td>
	</tr>
	<!-- 装载Weboffice控件 -->
