...
LQ.selectUi={
	show:function(options){
		var def={
			id:"", //selectUi鐨処D鍊�
			hiddenInput:"", //璁剧疆涓嬫媺鍒楄〃鑾峰彇鍊间繚瀛樼殑瀛楁锛�
			selectInit:"", //鎺ユ敹涓嬫媺琛ㄦ暟鎹紝鏁扮粍[{name:name,value:value}]
			selectNext:"", //浜岀骇鑿滃崟鍊�
			pulldown:function(){},//涓嬫媺鍒楄〃閫夋嫨鍚庤繑鍥炲嚱鏁�
			callback:function(){} //callback 鍒濆鎻掍欢鏃惰繑鍥炲嚱鏁�
		};
		...
		$this.bind("click",function(e){
			e.stopPropagation();
			var id=$(".select_ul_ui").index($this); //鑾峰彇绱㈠紩鍊�
			ulhide(id);
			ulStatus();
		});
