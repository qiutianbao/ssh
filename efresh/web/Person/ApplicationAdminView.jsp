...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>Person/JS/applyAuditAdmin.js"></script>
  </head>
  
  <body onkeydown="keyConvert()">
    <div id="unauditApplyTasksGrid" style="width: 100%; height: 100%"></div>
  </body>
</html>
