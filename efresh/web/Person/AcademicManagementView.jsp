...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>Person/JS/academicManageMethod.js"></script>
	
  </head>
  
  <body onkeydown="keyConvert()">
    <div id="academicInfoGrid" style="width: 100%; height: 100%"></div>
  </body>
</html>
