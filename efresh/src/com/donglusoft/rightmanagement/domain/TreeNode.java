 ...
 * @version 创建时间：2010-9-1 下午04:10:36 类说明
 */
public class TreeNode {
	...
	public TreeNode(){};
	public TreeNode(String cls, String href, String hrefTarget, String icon,
			String iconCls, String qtip, String text, String id,
			List<TreeNode> children, boolean leaf) {
		super();
		this.cls = cls;
		this.href = href;
