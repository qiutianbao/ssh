...
public class MobsetApiLocator extends org.apache.axis.client.Service implements com.yinli.util.sendsms.tempuri.MobsetApi {
    ...
    public com.yinli.util.sendsms.tempuri.MobsetApiSoap getMobsetApiSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.yinli.util.sendsms.tempuri.MobsetApiSoap getMobsetApiSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yinli.util.sendsms.tempuri.MobsetApiSoapStub _stub = new com.yinli.util.sendsms.tempuri.MobsetApiSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yinli.util.sendsms.tempuri.MobsetApiSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yinli.util.sendsms.tempuri.MobsetApiSoapStub _stub = new com.yinli.util.sendsms.tempuri.MobsetApiSoapStub(new java.net.URL(MobsetApiSoap_address), this);
                _stub.setPortName(getMobsetApiSoapWSDDServiceName());
                return _stub;
            }
        }
