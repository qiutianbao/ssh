				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;角色管理--&gt;新增角色 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="role/role_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>角色名称:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="role.name" type="text" class="cls_input_long"/>
                       </td>
                      ...
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <input name="role.value" type="text" class="cls_input_long"/>
                      </td>
