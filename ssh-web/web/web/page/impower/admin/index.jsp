...
<title>资源管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "adm/adm_showAdd.action";
	  }
	  function t_delete() {
	    var cks = document.getElementsByName("cks");
	    for(var i=0;i<cks.length;i++) {
	       if(cks[i].checked) {
	        window.location = "adm/adm_delete.action?ids="+cks[i].value;
	       } else {
	        alert("请选择至少一个用户");
	       }
	    }
				                ...
				                <td width="64%" valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /></div></td>
				                    <td width=""><span>你当前的位置</span>：系统管理--&gt;用户管理 </td>
				        ...
				        <td><table  width="100%" border="0" cellspacing="0"
				          ...
				          <tr>
				            <td width="8" background="web/images/table/tab_12.gif"
														bgcolor="#c9e5f7">&nbsp;</td>
				            <td>
				         <form id="form1" name="form1" method="post" action="adm/adm_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
                                  ...
                                  <td width="93"  valign="middle" class="form_td">负责人：</td>
								  <td width="152">
                                    <label><input name="username" type="text" size="12" class="cls_input_middle" value="${username}"/></label>
                                  </td>
                                  <td width="93"  valign="middle" class="form_td">(区/县)局：</td>
                                  <td width="152">
                                    <label><input name="area" type="text" size="12" class="cls_input_middle" value="${area}"/></label>
                                  </td>
                                  <td width="93"  valign="middle" class="form_td">角色：</td>
                                  <td width="152">
                                    <label><input name="roleName" type="text" size="12" class="cls_input_middle"/></label>
                                  </td>
                                </tr>
                           </table>
                             <table align="" width="100%">
                                  ...
                                  <input name="add" type="button" class="btn" value="新增" style="background: url(web/images/btn.png) no-repeat 0 0;" onclick="showAdd()" title="点击新增按钮跳转到添加用户页面"/>
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <td width="7%" height="22" background="web/images/table/bg.gif"><div align="center"> 
				                  <span class="STYLE1" background="web/images/table/bg.gif">用户名</span></div></td>
				                  <td width="7%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">负责人</div></td>
                                  <td width="7%" background="web/images/table/bg.gif"><div align="center"> 
                                  <span class="STYLE1" background="web/images/table/bg.gif">联系电话</span></div></td>
                                   <td width="7%" height="22" background="web/images/table/bg.gif"><div align="center">区县局</div></td>
                                  <td width="7%" height="22" background="web/images/table/bg.gif"><div align="center">地址</div></td>
			                      <td width="7%" height="22" background="web/images/table/bg.gif"><div align="center">密码</div></td>
			                      <td width="15%" height="22" background="web/images/table/bg.gif"><div align="center">角色</div></td>
			                      <td width="25%" height="22" background="web/images/table/bg.gif"><div align="center"> <span class="STYLE1">基本操作</span></div></td>
				                </tr>
				               <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center">${flag.account}</div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.username}</span></div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.phone}</span></div></td>
								  <td height="20" class="cls_table_fill"><div align="center">${flag.area}</div></td>
			                      <td height="20" class="cls_table_fill"><div align="center">${flag.address}</div></td>
			                      <td height="20" class="cls_table_fill"><div align="center">${flag.password}</div></td>
			                      <td height="20" class="cls_table_fill"><div align="center">
			                      <c:forEach var="role" items="${flag.roleSet}">
			                      ${role.name},
			                      </c:forEach>
			                      </div></td>
			                      <td height="10" class="cls_table_fill" align="center"><div>
			                      <span class="cls_span_topOP"><img src="web/images/037.gif" alt="编辑" /><span> [</span><a href="adm/adm_showUpdate.action?id=${flag.id}"  title="点击编辑连接跳转到修改用户信息页面">编辑</a><span>]</span></span>
			                      <span class="cls_span_topOP">&nbsp;&nbsp;&nbsp;&nbsp;<img src="web/images/11.gif" alt="删除" /><span> [</span> <a href="adm/adm_delete.action?ids=${flag.id}"  id="" title="点击删除链接删除">删除</a><span>]</span></span>
			                      </div></td>
				                </tr>
				              </c:forEach>
			                  </table></td>
				            ...
				            <td><table width="100%" border="0" cellspacing="0"
				              ...
				              <tr>
				                ...
				                <td>
				                  ...
				                  <tr>
				                   <pg:pager items="${pager.totalNum}" maxIndexPages="5" maxPageItems="3" url="adm/adm_findByKeys.action" export="currentPageNo = pageNumber">
				                    <c:if test="${area!=null}">
