<%@page import="com.bf.entity.Admin"%>
...
<script type="text/javascript">
		...
		function getRole() {
		   <%
		     List<Role> allRoles = (List<Role>)request.getAttribute("roles");
		     Admin admin = (Admin)request.getAttribute("admin");
		     Set<Role> adminRoles = admin.getRoleSet();
		     for(Role allRole : allRoles) {
		       for(Role role : adminRoles) {
		         if(role.getId().equals(allRole.getId())) {
		            %>
		            document.getElementById("<%=role.getId()%>").checked=true;
		            <%
		         }
		       }
		     }
				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;用户管理--&gt;编辑用户 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="adm/adm_update.action" method="post">
                  <input type="hidden" name="admin.id" value="${admin.id}">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>用户名:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="admin.account" type="text" class="cls_input_long" value="${admin.account}"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                        <td width="9%" height="20" class="form_td"><div align="center"><span>负责人:</span></div></td>
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <input name="admin.username" type="text" class="cls_input_long" value="${admin.username}"/>
                      </td>
                      <td width="20%" class="cls_table_fill"><div align="center"><font color="#FF0000"></font></div></td>
                    </tr>
                    
                     <tr>
					  <td height="20"   class="form_td"><div align="center"><span>电话:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.phone" type="text" class="cls_input_long" value="${admin.phone}"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                      <td height="20"  class="form_td"><div align="center"><span>区县局:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.area" type="text" class="cls_input_long" value="${admin.area}"/>
                       </td>
                      <td class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                    </tr>
                    
                    <tr>
					  <td height="20"   class="form_td"><div align="center"><span>地址:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.address" type="text" class="cls_input_long" value="${admin.address}"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                      <td height="20"  class="form_td"><div align="center"><span>角色:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        &nbsp;&nbsp;
                       <c:forEach var="flag" items="${roles}">
                       <input type="checkbox" value="${flag.id}" name="roleIds" id="${flag.id}">${flag.name}&nbsp;&nbsp;
                       </c:forEach>
                       </td>
                      <td class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                    </tr>
                    ...
                    <tr>
					  <td height="20"   class="form_td"><div align="center"><span>密码:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.password" type="text" class="cls_input_long" value="${admin.password}"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                    </tr>
