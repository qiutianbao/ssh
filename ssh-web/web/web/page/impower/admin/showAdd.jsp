				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;用户管理--&gt;新增用户 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="adm/adm_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      ...
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="admin.account" type="text" class="cls_input_long"/>
                       </td>
                      ...
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <input name="admin.username" type="text" class="cls_input_long"/>
                      </td>
                     ...
                     <tr>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.phone" type="text" class="cls_input_long"/>
                      </td>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.area" type="text" class="cls_input_long"/>
                       </td>
                    ...
                    <tr>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.address" type="text" class="cls_input_long"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                      ...
                      <td height="20" class="cls_table_fill"> 
                       ...
                       <input type="checkbox" value="${flag.id}" name="roleIds">${flag.name}&nbsp;&nbsp;
                       </c:forEach>
                       </td>
                      <td class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                    </tr>
                     ...
                     <tr>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="admin.password" type="text" class="cls_input_long"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                    </tr>
