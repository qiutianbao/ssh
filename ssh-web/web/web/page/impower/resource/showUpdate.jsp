				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;资源管理--&gt;修改资源 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="res/res_update.action" method="post">
                  <input type="hidden" name="resource.id" value="${resource.id}">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>资源名:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="resource.name" type="text" class="cls_input_long" value="${resource.name}"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                        <td width="9%" height="20" class="form_td"><div align="center"><span>上级资源:</span></div></td>
                      <td width="25%" height="20" class="cls_table_fill"> 
                        &nbsp;&nbsp;<select name="pid" style="width:135px;" title="请选择资源">
                                    <option value="0"> --无上级-- </option>
                                    <c:if test="${fn:length(parentResources)==0}">
                                      <option value="${resource.parent.id}" selected="selected"> ${resource.parent.name} </option>
                                    </c:if>
				                    <c:forEach var="flag" items="${parentResources}">
				                    <c:choose>
				                      <c:when test="${resource.parent==null}">
                     ...
                     <tr>
					  <td height="20"   class="form_td"><div align="center"><span>地址URL:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="resource.url" type="text" class="cls_input_long" value="${resource.url}"/>
                      </td>
                      <td  class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div>
                      <td height="20"  class="form_td"><div align="center"><span>资源标识:</span></div></td>
                      <td height="20" class="cls_table_fill"> 
                        <input name="resource.value" type="text" class="cls_input_long" value="${resource.value}"/>
                       </td>
                    ...
                    <tr>
                      <td height="20" colspan="6" align="right" class="cls_table_fill"> 
                           <input name="button2"  type="submit" class="cls_button_short" style="background: url(web/images/btn.png) no-repeat 0 0;" value="修改" title="点击修改按钮修改"/> 
