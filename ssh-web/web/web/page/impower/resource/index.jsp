...
<title>资源管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "res_showAdd.action";
	  }
	  function t_delete() {
	    var cks = document.getElementsByName("cks");
	    for(var i=0;i<cks.length;i++) {
	       if(cks[i].checked) {
	        window.location = "res_logicDel.action?ids="+cks[i].value;
	       }
	    }
	  }
    </script>
				                ...
				                <td width="64%" valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /></div></td>
				                    <td width=""><span>你当前的位置</span>：系统管理--&gt;资源管理 </td>
				        ...
				        <td><table  width="100%" border="0" cellspacing="0"
				          ...
				          <tr>
				            <td width="8" background="web/images/table/tab_12.gif"
														bgcolor="#c9e5f7">&nbsp;</td>
				            <td>
				         <form id="form1" name="form1" method="post" action="res/res_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
                                  ...
                                  <td width="93"  valign="middle" class="form_td">资源名：</td>
								  <td width="152">
                                    <label>
                                    <input name="key" type="text" size="12" class="cls_input_middle" value="${key}"/>
                                  </label></td>
                                </tr>
                           </table>
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <span class="STYLE1" background="web/images/table/bg.gif">资源名</span></div></td>
				                  <td width="9%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">资源标识</div></td>
                                  <td width="12%" background="web/images/table/bg.gif"><div align="center"> 
                                  <span class="STYLE1" background="web/images/table/bg.gif">上级资源</span></div></td>
                                  <td width="10%" height="22" background="web/images/table/bg.gif"><div align="center">URL</div></td>
                                  <td width="10%" height="22" background="web/images/table/bg.gif"><div align="center">下级资源</div></td>
			                      <td width="20%" height="22" background="web/images/table/bg.gif"><div align="center"> <span class="STYLE1">基本操作</span></div></td>
				                </tr>
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center"> <span>${flag.value}</span></div></td>
				                  <c:choose>
				                    <c:when test="${flag.parent != null}">
				                    <td height="20" class="cls_table_fill"><div align="center"> <span>${flag.parent.name}</span></div></td>
				                    </c:when>
				                    <c:otherwise>
				                     <td height="20" class="cls_table_fill"><div align="center"> <span>没有上级资源</span></div></td>
				                    </c:otherwise>
				                  </c:choose>
								  <td height="20" class="cls_table_fill"><div align="center">${flag.url}</div></td>
								  <c:choose>
								     <c:when test="${fn:length(flag.children)>0}">
								     <td height="20" class="cls_table_fill"><div align="center"><a href="res/res_findByPid.action?pid=${flag.id}">查看下级资源</a></div></td>
								     </c:when>
								     <c:otherwise>
								     <td height="20" class="cls_table_fill"><div align="center">没有下级资源</div></td>
								     </c:otherwise>
								  </c:choose>
			                      <td height="20" class="cls_table_fill" align="center">
			                      <div>
			                      <span class="cls_span_topOP"><img src="web/images/037.gif" alt="编辑" /><span> [</span><a href="res/res_showUpdate.action?id=${flag.id}"  title="点击编辑连接跳转到修改用户信息页面">编辑</a><span>]</span></span>
			                      <span class="cls_span_topOP">&nbsp;&nbsp;&nbsp;&nbsp;<img src="web/images/11.gif" alt="删除" /><span> [</span> <a href="res/res_logicDel.action?ids=${flag.id}"  id="id_a_confirm" title="点击删除链接删除">删除</a><span>]</span></span>
			                      <span class="cls_span_topOP"><img src="web/images/037.gif" alt="编辑" /><span> [</span><a href="res/res_showAdd2.action?id=${flag.id}"  title="点击编辑连接跳转到修改用户信息页面">新增</a><span>]</span></span>
			                      </div></td>
				                </tr>
				                </c:forEach>
			                  </table></td>
				            ...
				            <td><table width="100%" border="0" cellspacing="0"
				              ...
				              <tr>
				                ...
				                <td><table border="0" align="right" cellpadding="0" cellspacing="0">
				                  <tr>
				                   <pg:pager items="${pager.totalNum}" maxIndexPages="5" maxPageItems="3" url="res/res_findByKeys.action" export="currentPageNo = pageNumber">
				                    <c:if test="${key!=null}">
