				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;资源管理--&gt;新增资源 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="res/res_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      ...
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="resource.name" type="text" class="cls_input_long"/>
                       </td>
                     ...
                     <tr>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="resource.url" type="text" class="cls_input_long"/>
                      </td>
                      ...
                      <td height="20" class="cls_table_fill"> 
                        <input name="resource.value" type="text" class="cls_input_long"/>
                       </td>
