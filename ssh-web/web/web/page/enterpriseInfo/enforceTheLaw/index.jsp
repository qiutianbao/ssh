...
<title>企业信息管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "reddereIusInfo/reddereIusInfo_showAdd.action";
	  }
	  function t_delete() {
				         ...
				         <form id="form1" name="form1" method="post" action="adm/adm_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
                                  ...
                                  <td width="93"  valign="middle" class="form_td">案件名称：</td>
								  <td width="152">
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <span class="STYLE1" background="web/images/table/bg.gif">案件编号</span></div></td>
				                  <td width="7%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">案件名称</div></td>
				              ...
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center">${flag.caseNo}</div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.caseName}</span></div></td>
