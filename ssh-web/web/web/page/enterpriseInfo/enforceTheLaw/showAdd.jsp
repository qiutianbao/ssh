          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="reddereIusInfo/reddereIusInfo_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>案件编号:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="reddereIusInfo.caseNo" type="text" class="cls_input_long"/>
                       </td>
                    ...
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>案件名称:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="reddereIusInfo.caseName" type="text" class="cls_input_long"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                    </tr>
