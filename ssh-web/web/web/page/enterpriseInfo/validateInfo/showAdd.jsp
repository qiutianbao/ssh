				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;角色管理--&gt;添加验证 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="cqValidateInfo/cqValidateInfo_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>验证编号:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="cqValidateInfo.validateNo" type="text" class="cls_input_long"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                        <td width="9%" height="20" class="form_td"><div align="center"><span>产品名称:</span></div></td>
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <select style="width:135px;" title="请选择" name="pid">
                         <c:forEach var="flag" items="${products}">
                    ...
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>验证人:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="cqValidateInfo.validateUserName" type="text" class="cls_input_long"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                    </tr>
