...
<title>企业信息管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "cqValidateInfo/cqValidateInfo_showAdd.action";
	  }
	  function t_delete() {
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <span class="STYLE1" background="web/images/table/bg.gif">验证编号</span></div></td>
				                  <td width="7%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">验证人</div></td>
                                  <td width="7%" background="web/images/table/bg.gif"><div align="center"> 
                                  <span class="STYLE1" background="web/images/table/bg.gif">产品名称</span></div></td>
				              ...
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center">${flag.validateNo}</div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.validateUserName}</span></div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.product.name}</span></div></td>
