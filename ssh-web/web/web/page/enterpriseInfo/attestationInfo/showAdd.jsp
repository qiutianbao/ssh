          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="attestationInfo/attestationInfo_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>证书编号:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="attestationInfo.attestationNo" type="text" class="cls_input_long"/>
                       </td>
