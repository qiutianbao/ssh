...
<title>企业信息管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "attestationInfo_showAdd.action";
	  }
	  function t_delete() {
				                ...
				                <td width="64%" valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /></div></td>
				                    <td width=""><span>你当前的位置</span>：企业信息管理--&gt;产品认证 </td>
				         ...
				         <form id="form1" name="form1" method="post" action="adm/adm_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
                                  ...
                                  <td width="93"  valign="middle" class="form_td">证书编号：</td>
								  <td width="152">
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <span class="STYLE1" background="web/images/table/bg.gif">证书编号</span></div></td>
				                  <td width="7%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">产品名称</div></td>
				              ...
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center">${flag.attestationNo}</div></td>
