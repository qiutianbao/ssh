...
<title>企业信息管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "product/product_showAdd.action?eid="+${eid};
	  }
	  function t_delete() {
				                ...
				                <td width="64%" valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /></div></td>
				                    <td width=""><span>你当前的位置</span>：企业信息管理--&gt;产品信息 </td>
				         ...
				         <form id="form1" name="form1" method="post" action="adm/adm_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
                                  ...
                                  <td width="93"  valign="middle" class="form_td">产品名称：</td>
								  <td width="152">
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <div align="center" background="web/images/table/bg.gif">认证</div></td>
                                  <td width="7%" background="web/images/table/bg.gif"><div align="center"> 
                                  <span class="STYLE1" background="web/images/table/bg.gif">验证</span></div></td>
			                      <td width="15%" height="22" background="web/images/table/bg.gif"><div align="center">执法</div></td>
				              ...
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.attestation}</span></div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.validate}</span></div></td>
								  <td height="20" class="cls_table_fill"><div align="center">${flag.reddereIus}</div></td>
