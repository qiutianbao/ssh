...
<title>企业信息管理</title>
	...
	<script type="text/javascript">
	  function showAdd() {
	    window.location = "enterprise/enterprise_showAdd.action";
	  }
	  function t_delete() {
				                ...
				                <td width="64%" valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /></div></td>
				                    <td width=""><span>你当前的位置</span>：企业信息管理--&gt;基础信息 </td>
				         ...
				         <form id="form1" name="form1" method="post" action="adm/adm_findByKeys.action">
				           <table id="tab" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr align="left">
								  ...
								  <td width="152">
                                    <label><input name="username" type="text" size="12" class="cls_input_middle"/></label>
                                  </td>
                                  <td width="93"  valign="middle" class="form_td">(区/县)局：</td>
                                  <td width="152">
                                    <label><input name="area" type="text" size="12" class="cls_input_middle" /></label>
                                  </td>
                                  <td width="93"  valign="middle" class="form_td">地址：</td>
                                  <td width="152">
					  ...
					  <div class="cls_scroll" style="width:710px;">
				              <table id="tab" width="100%" border="0" cellpadding="0"
				                ...
				                <tr style="color:#2E5D7D;">
				                  ...
				                  <span class="STYLE1" background="web/images/table/bg.gif">企业名称</span></div></td>
				                  <td width="7%" height="22" background="web/images/table/bg.gif">
				                  <div align="center" background="web/images/table/bg.gif">地址</div></td>
                                  <td width="7%" background="web/images/table/bg.gif"><div align="center"> 
                                  <span class="STYLE1" background="web/images/table/bg.gif">区县局</span></div></td>
			                      <td width="15%" height="22" background="web/images/table/bg.gif"><div align="center">认证类别</div></td>
				              ...
				              <c:forEach var="flag" items="${pager.pageList}">
								<tr>
				                  ...
				                  <input type="checkbox" name="cks" value="" /></div>
				                  </td>
				                  <td height="20" class="cls_table_fill"><div align="center">${flag.name}</div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.address}</span></div></td>
				                  <td height="20" class="cls_table_fill"><div align="center"><span>${flag.area}</span></div></td>
								  <td height="20" class="cls_table_fill"><div align="center">${flag.typeName}</div></td>
			                      <td height="20" class="cls_table_fill" align="center"><div>
			                      <span class="cls_span_topOP"><img src="web/images/037.gif" alt="编辑" /><span> [</span><a href=""  title="点击编辑连接跳转到修改用户信息页面">编辑</a><span>]</span></span>
			                      <span class="cls_span_topOP">&nbsp;&nbsp;&nbsp;&nbsp;<img src="web/images/037.gif" alt="编辑" /><span> [</span><a href="product/product_index.action?eid=${flag.id}"  title="点击编辑连接跳转到修改用户信息页面">查看产品</a><span>]</span></span>
			                      <span class="cls_span_topOP">&nbsp;&nbsp;&nbsp;&nbsp;<img src="web/images/11.gif" alt="删除" /><span> [</span> <a href=""  id="" title="点击删除链接删除">删除</a><span>]</span></span>
			                      </div></td>
				                </tr>
				                </c:forEach>
			                  </table></td>
