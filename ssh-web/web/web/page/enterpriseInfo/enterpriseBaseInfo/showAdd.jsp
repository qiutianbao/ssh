				                ...
				                <td valign="middle"><table width="100%" border="0" cellspacing="0"
				                  ...
				                  <tr>
				                    <td width="5%"><div align="center"> <img src="web/images/table/tb.gif" width="16"
																						height="16" /> </div></td>
				                    <td width="95%"><span>你当前的位置</span>：系统管理--&gt;角色管理--&gt;新增企业 </td>
                      </tr>
                    </table></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
                ...
                <td>
                <form action="enterprise/enterprise_add.action" method="post">
                  <table id="tab" width="100%" border="0" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>企业名称:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="enterprise.name" type="text" class="cls_input_long"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                        <td width="9%" height="20" class="form_td"><div align="center"><span>企业地址:</span></div></td>
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <input name="enterprise.address" type="text" class="cls_input_long"/>
                      </td>
                      <td width="20%" class="cls_table_fill"><div align="center"><font color="#FF0000"></font></div></td>
                    </tr>
                    
                    <tr>
                      <td width="10%" height="20" class="form_td"  ><div align="center"><span>企业区域:</span></div></td>
                      <td width="23%" height="20" class="cls_table_fill" > 
                        <input name="enterprise.area" type="text" class="cls_input_long"/>
                       </td>
                      <td width="13%" class="cls_table_fill"><div align="left"><font color="#FF0000">*</font></div></td>
                        <td width="9%" height="20" class="form_td"><div align="center"><span>认证类型:</span></div></td>
                      <td width="25%" height="20" class="cls_table_fill"> 
                        <select name="enterprise.typeName" style="width:135px;" title="请选择">
                          <option value="自愿认证">自愿认证</option>
                          <option value="强制认证">强制认证</option>
                        </select>
                      </td>
                      <td width="20%" class="cls_table_fill"><div align="center"><font color="#FF0000"></font></div></td>
                    </tr>
